...
public class MyCalendarActivity extends Activity implements OnClickListener {
	...
	private static final String dateTemplate_label = "MMM dd";
	private TextView year_label, date_label;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		prevMonth = (ImageView) this.findViewById(R.id.prevMonth1);
		prevMonth.setOnClickListener(this);

		currentMonth = (TextView) this.findViewById(R.id.currentMonth1);
		currentMonth.setText(DateFormat.format(dateTemplate, _calendar.getTime()));

		nextMonth = (ImageView) this.findViewById(R.id.nextMonth1);
		nextMonth.setOnClickListener(this);

		calendarView = (GridView) this.findViewById(R.id.calendar1);
		...
		String date_label_string = String.valueOf(DateFormat.format(dateTemplate_label, _calendar.getTime()));
		
		date_label.setText(dayOfTheWeek+", "+date_label_string);
	...
	public class GridCellAdapter extends BaseAdapter implements OnClickListener {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (day_color[1].equals("GREY")) {
				...
				//gridcell.setBackgroundColor(255);
			}
			...
			if (day_color[1].equals("BLUE")) {
				...
				gridcell.setBackgroundDrawable(getResources().getDrawable(R.drawable.calendar_tile_small_select));
			}
			return row;
		}
